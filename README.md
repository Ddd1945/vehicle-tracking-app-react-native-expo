...
3. If you want to configure build project by himself check the official documentation - <a href="https://docs.expo.dev/build/setup/" target="_blank"><b><i>EXPO DOCS</i></b></a>
